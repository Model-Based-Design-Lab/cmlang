...
public class MarkovChainsInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new MarkovChainsStandaloneSetup() {
			@Override
	...
	protected MarkovChainsRuntimeModule createRuntimeModule() {
		...
		return new MarkovChainsRuntimeModule() {
			@Override
			public ClassLoader bindClassLoaderToInstance() {
				return MarkovChainsInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
