...
public class FiniteStateAutomataInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new FiniteStateAutomataStandaloneSetup() {
			@Override
	...
	protected FiniteStateAutomataRuntimeModule createRuntimeModule() {
		...
		return new FiniteStateAutomataRuntimeModule() {
			@Override
			public ClassLoader bindClassLoaderToInstance() {
				return FiniteStateAutomataInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
