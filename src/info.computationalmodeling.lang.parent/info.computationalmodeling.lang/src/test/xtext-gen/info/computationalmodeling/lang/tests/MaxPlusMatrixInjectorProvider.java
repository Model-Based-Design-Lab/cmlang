...
public class MaxPlusMatrixInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new MaxPlusMatrixStandaloneSetup() {
			@Override
	...
	protected MaxPlusMatrixRuntimeModule createRuntimeModule() {
		...
		return new MaxPlusMatrixRuntimeModule() {
			@Override
			public ClassLoader bindClassLoaderToInstance() {
				return MaxPlusMatrixInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
