...
public class RegularExpressionsInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new RegularExpressionsStandaloneSetup() {
			@Override
	...
	protected RegularExpressionsRuntimeModule createRuntimeModule() {
		...
		return new RegularExpressionsRuntimeModule() {
			@Override
			public ClassLoader bindClassLoaderToInstance() {
				return RegularExpressionsInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
