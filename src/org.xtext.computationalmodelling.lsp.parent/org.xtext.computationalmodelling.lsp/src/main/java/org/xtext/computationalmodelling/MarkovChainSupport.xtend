...
import org.xtext.computationalmodelling.markovchains.MarkovChainModel
import java.util.Set
import org.xtext.computationalmodelling.markovchains.Edge
import org.xtext.computationalmodelling.markovchains.State
import org.xtext.computationalmodelling.markovchains.Probability
import org.xtext.computationalmodelling.markovchains.Reward
...
class MarkovChainSupport {
	...
	static def addEdgeStatesECoreMap(Edge edge, HashMap<String,  org.xtext.computationalmodelling.markovchains.State> map) {
	...
	{
		var HashMap<String, org.xtext.computationalmodelling.markovchains.State> result = new HashMap<String, org.xtext.computationalmodelling.markovchains.State>()
		for (e: m.edges) {
